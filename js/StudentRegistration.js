...
function setupFormValidation() {
    ...
    contactInput.addEventListener('input', () => utils.validateContactNumber(contactInput));
    contactInput.addEventListener('blur', () => utils.validateContactNumber(contactInput));
